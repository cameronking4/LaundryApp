...
class UserDataRepository extends BaseRepository {
  ...
  Future<bool> addToCart(Map map) =>
      userDataProvider.addToCart(map);
  ...
  Future<bool> increaseQuantity(
          String quantity, String uid, String productId,String id) =>
      userDataProvider.increaseQuantity(quantity, uid, productId,id);
  ...
  //coupon
  Future<Coupon> applyCoupon(Map map) => userDataProvider.applyCoupon(map);
