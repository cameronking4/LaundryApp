...
class _AddCardScreenState extends State<AddCardScreen> {
  ...
  void initState() {
    ...
    creditCardModel = CreditCardModel('', '', '', 'XXX', false);
    ...
    cardBloc.listen((state) {
      ...
      if (state is AddCardInProgressState) {
        print('Adding the CARD');
      }
      if (state is AddCardCompletedState) {
        print('ADDED');
      }
    });
  }
                  ...
                  child: FlatButton(
                    onPressed: () {
                      ...
                      if (cardNo.toString().trim().length < 19 ||
                        ...
                        cardBloc.add(AddCardEvent(cardMap));
