      ...
      if (state is ApplyCouponCompletedState) {
        if (isApplying) {
          ...
          if (state.res.couponCode != null) {
            ...
            //not found
            showSnack('Invalid coupon!', context);
          }
        }
      }
    });
                                  ...
                                  if (state is GetCartValuesCompletedState) {
                                    ...
                                    if (appliedCoupon) {
                                      ...
                                      shippingAmt = double.parse(
                                          cartValues.cartInfo.shippingAmt);
                                      for (var product in cartProducts) {
                                        var price;
                                      ...
                                      if (totalOrderAmt >
                                          double.parse(cartValues
                                              .cartInfo.discountAmt)) {
                                        discountAmt = (double.parse(cartValues
                                                    .cartInfo.discountPer) /
                                                100) *
                                            totalOrderAmt;
                                      }

                                      taxAmt = (double.parse(
                                                  cartValues.cartInfo.taxPer) /
                                              100) *
                                          totalOrderAmt;
                                      ...
                                      if (coupon.type == 'LIMITED_USE_COUPON') {
                                        //limited no of use
                                        if (coupon.usedNoOfTimes <
                                            int.parse(coupon.noOfUses)) {
                                          //allow it
                                          double couponDiscountPer =
                                              double.parse(coupon.discount);
                                          couponDiscountAmt = (totalOrderAmt +
                                                  taxAmt +
                                                  shippingAmt -
                                                  discountAmt) *
                                              couponDiscountPer /
                                    ...
                                    // if (totalOrderAmt >
                                    //     double.parse(
                                    //         cartValues.cartInfo.discountAmt)) {
                                    //   discountAmt = (double.parse(cartValues
                                    //               .cartInfo.discountPer) /
                                    //           100) *
                                    //       totalOrderAmt;
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Text(
                                                              '- ${Config().currency}${couponDiscountAmt.toStringAsFixed(2)}',
                                                              style: GoogleFonts
                                                                  .lora(
                                                                color: Colors
                                                                    .green
