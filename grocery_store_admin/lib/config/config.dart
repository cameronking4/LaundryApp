...
//TODO: change the currency and country prefix as per your need
  ...
  String appName = 'My Wash App Admin';
...
//TODO:change this package name to yours
  String packageName = 'com.eleven11.laundryAdmin';
  ...
  String updateMessagesUrl =
      'https://us-central1-mywashapp-2b43a.cloudfunctions.net/updateAnsweredMessageAnalytics'; //it should look something like : https://us-********-**********.cloudfunctions.net/updateAnsweredMessageAnalytics
