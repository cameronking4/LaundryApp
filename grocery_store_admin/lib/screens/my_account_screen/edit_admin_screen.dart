...
import 'package:ecommerce_store_admin/blocs/my_account_bloc/edit_admin_bloc.dart';
...
class EditAdminScreen extends StatefulWidget {
  ...
  const EditAdminScreen({Key key, this.admin}) : super(key: key);
...
class _EditAdminScreenState extends State<EditAdminScreen> {
  ...
  var image;
  var selectedImage;
  EditAdminBloc editAdminBloc;
  bool isAdding;

  String mobileNo, email, profileImageUrl;
  ...
  void initState() {
    ...
    isAdding = false;
    editAdminBloc = BlocProvider.of<EditAdminBloc>(context);

    profileImageUrl = widget.admin.profileImageUrl;
    mobileNo = widget.admin.mobileNo;
    email = widget.admin.email;

    editAdminBloc.listen((state) {
      print('EDIT ADMIN BLOC :: $state');

      if (state is EditAdminInProgressState) {
        //in progress
        showUpdatingDialog();
      }
      if (state is EditAdminFailedState) {
        //failed
        if (isAdding) {
          Navigator.pop(context);
          showSnack('Failed to update admin!', context);
          isAdding = false;
        }
      }
      if (state is EditAdminCompletedState) {
        //completed
        if (isAdding) {
          isAdding = false;
          Navigator.pop(context);
  ...
  editAdmin() async {
    if (_formKey.currentState.validate()) {
      ...
      adminMap.putIfAbsent(
          'profileImageUrl', () => widget.admin.profileImageUrl);

      adminMap.addAll({
        'uid': widget.admin.uid,
        'primaryAdmin': widget.admin.primaryAdmin,
        'name': widget.admin.name,
        'tokenId': widget.admin.tokenId,
        'accountStatus': widget.admin.accountStatus,
        'password': widget.admin.password,
        'activated': widget.admin.activated,
      });

      editAdminBloc.add(
        EditAdminEvent(adminMap),
      );
      isAdding = true;
    }
  }
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                        ...
                        child: Stack(
                          children: <Widget>[
                            Container(
                              ...
                              child: widget.admin.profileImageUrl.isEmpty &&
                                      selectedImage == null
                                  ? Icon(
                                      Icons.person,
                                      size: 50.0,
                                  ...
                                  : selectedImage != null
                                      ...
                                      : ClipRRect(
                                          ...
                                          child: FadeInImage.assetNetwork(
                                            ...
                                            image: widget.admin.profileImageUrl,
                                            fit: BoxFit.cover,
                                            fadeInDuration:
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      height: 30.0,
                                      child: Icon(
                                        widget.admin.profileImageUrl.isNotEmpty
                                            ? Icons.edit
                                            : Icons.add,
                                        color: Colors.white,
                                        size: 16.0,
                      ...
                      // ),
                      // Text(
                      //   'NOTE: Password for the new admin account will be randomly generated and displayed to you in all admins panel.',
                      //   style: GoogleFonts.lora(
                      //     color: Colors.black54,
                      //     fontSize: 13.5,
